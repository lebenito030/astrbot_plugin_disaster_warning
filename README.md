...
插件支持省份白名单过滤功能，只推送指定省份的预警消息：

```text
省份白名单: ["四川", "云南", "西藏"]  # 仅推送这些省份的预警
省份白名单: []                        # 留空则不过滤（推送所有省份）
```
...
# 省份白名单管理
/灾害预警白名单 查看              # 查看当前白名单
/灾害预警白名单 添加 四川          # 添加四川到白名单
/灾害预警白名单 添加 云南          # 添加云南到白名单
/灾害预警白名单 删除 四川          # 从白名单删除四川
/灾害预警白名单 清空              # 清空整个白名单
```
